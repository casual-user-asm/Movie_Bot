#!/home/casual-user/Movies_Bot/venv/bin/python3
# -*- coding: utf-8 -*-
"""
...
from movies.parser.sql.dbschema import DB_SCHEMA, dropTables, createTables, createIndexes
from movies.parser.sql import soundex
from movies.utils import analyze_title, analyze_name, date_and_notes, \
    build_name, build_title, normalizeName, normalizeTitle, _articles, \
        build_company_name, analyze_company_name, canonicalTitle
from movies._exceptions import IMDbParserError, IMDbError
from movies.parser.sql.alchemyadapter import getDBTables, setConnection
